...
<div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <a href="{{ url('/products/' . $product->slug) }}" class="block rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full mb-4">
            <img class="mx-auto rounded h-full dark:hidden" src="{{ asset('storage/' . $product->images[0]) }}" alt="" />
        </div>
        <div class="pt-2">
            <p class="text-sm font-semibold leading-tight text-gray-900 dark:text-white">{{ $product->name }}</p>
            <div class="mt-2 flex items-center justify-between gap-4">
                <p class="text-md font-bold leading-tight text-gray-900 dark:text-white">{{ $product->price }} da</p>
