...
<section class="bg-gray-50 py-8 antialiased md:py-12 min-h-screen">
...
<div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <div class="flex items-center space-x-4">
          ...
          <!-- <div class="relative w-full sm:w-64">
              <input type="text" wire:model.defer="searchTerm" placeholder="Search products..." 
                  class="w-full rounded-md border border-gray-300 px-3 py-2 pr-16 text-sm focus:ring-2 focus:ring-blue-500">
    ...
    <button @click="open = true" type="button" class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 sm:w-auto">
    ...
    <div x-show="open" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div @click.away="open = false" class="w-full max-w-md rounded-lg bg-white shadow-lg">
          ...
          <div id="dropdownSort1" class="z-50 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow" data-popper-placement="bottom">
            <ul class="p-2 text-left text-sm font-medium text-gray-500" aria-labelledby="sortDropdownButton">
              <li>
                <a href="#"  wire:click.prevent="setSortOption('Newest')" class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900"> Newest </a>
              </li>
              <li>
                <a href="#"  wire:click.prevent="setSortOption('Oldest')" class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900"> Oldest </a>
              </li>
              <li>
                <a href="#"  wire:click.prevent="setSortOption('Increasing price')" class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900"> Increasing price </a>
              </li>
              <li>
                <a href="#"  wire:click.prevent="setSortOption('Decreasing price')" class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900"> Decreasing price </a>
              </li>
            </ul>
          </div>
      </div>
        ...
        <div class="mb-4 grid gap-4 grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-5">
          ...
          <a href="{{ url('/products/' . $product->slug) }}" class="block rounded-lg border border-gray-200 bg-white p-2 sm:p-3 shadow-sm">
