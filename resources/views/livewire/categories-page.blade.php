            ...
            @foreach($categories as $cat)
                <div class="flex-shrink-0 p-2" :style="'width: ' + mobileViewWidth">
                    <div @click="updateLivewire({{ $cat->id }})"
                        ...
                        class="flex flex-col items-center p-4 rounded-3xl border-2 cursor-pointer hover:bg-gray-100 transition-all">
...
<div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                  ...
                  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                      <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ms-2">Categories</a>
                      </div>
                    </li>
                  </ol>
                </nav>
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
        ...
        @else
          ...
          <a href="{{ url('/products/' . $product->slug) }}" class="block rounded-lg border border-gray-200 bg-white p-3 sm:p-6 shadow-sm">
              ...
              <div>
                  <p class="line-clamp-2 overflow-hidden text-ellipsis text-sm sm:text-base leading-tight text-gray-900">
                    {{ $product->name }}</p>
                  <div class="mt-2 flex items-center justify-between gap-4">
                      <p class="text-lg sm:text-xl font-bold leading-tight text-gray-900 mt-2">{{ $product->price }} da</p>
                  </div>
                  <p class="line-clamp-2 overflow-hidden text-ellipsis text-sm sm:text-base leading-tight text-gray-900">
