...
<nav class="bg-white border-gray-200 dark:bg-gray-900 border">
  <div class="max-w-screen-xl px-3 py-3 sm:mx-auto flex flex-wrap items-center">
    ...
    <div class="max-w-md ml-2 md:ml-20 lg:ml-44 flex-1 lg:w-full">   
        ...
        <div class="relative">
            ...
            <input 
                ...
                class="block w-full p-2.5 ps-9 pe-0 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
    ...
    <div class="flex items-center ml-auto">
        ...
        @if(!auth()->user())
        <button wire:click="goToLogin" type="button" class="flex gap-1 font-arabic ml-2 text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
