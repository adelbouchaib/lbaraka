    ...
    <div class="max-w-md ml-2 md:ml-20 lg:ml-44 flex-1 lg:w-full">   
        ...
        <div class="relative">
            ...
            <input 
                ...
                class="block w-full p-2.5 ps-9 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
