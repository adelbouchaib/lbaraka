...
<div class="flex flex-col w-16 md:w-1/3 border-r border-gray-200">
    <div class="flex items-center h-20 gap-2 px-5 border-b border-gray-200/90">
    ...
    <!-- Search Bar -->
    <div class="hidden md:block sticky top-0 z-10 h-20 p-5 border-b border-gray-200/90">
     ...
     <div class="md:hidden block sticky top-0 z-10 p-1 border-b border-gray-200/90">
    ...
    <div class="flex-1 overflow-y-auto">
                                ...
                                <div class="flex items-center justify-between gap-1">
                                    <p class="text-sm text-gray-600 truncate">
                                        @if($conversation->is_sender)
                                            <span class="text-primary-600 font-bold">You: </span>
                                        @endif
        ...
        @else
            <div class="flex flex-col items-center justify-center h-full">
                ...
                <p class="text-base text-gray-600 hidden md:block">
