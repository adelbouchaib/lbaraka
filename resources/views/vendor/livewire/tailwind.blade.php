                                ...
                                @foreach ($element as $page => $url)
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            ...
                                            <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-gray-800 border border-gray-800 cursor-default leading-5 dark:bg-gray-700 dark:border-gray-600">
                                            {{ $page }}</span>
                                            </span>
                                        @else
